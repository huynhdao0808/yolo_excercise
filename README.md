...
## Summary of YOLO
YOLO or You Only Look Once is an state-of-the-art agorithm in object detection task. It've proved the oustanding efficiency (time and accuracy) compared to other object detection agorithm such as R-CNN or SSD.
